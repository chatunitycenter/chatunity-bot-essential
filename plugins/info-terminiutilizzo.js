...
function generateMenuText(prefix, botName, userCount) {
    return `
*Tutte le informazioni menzionate qui non escludono il proprietario del bot e i Proprietari accreditati per l'uso di chatunity-bot-essential*
...
_- La chat anonima del comando #start, come suggerisce il nome, non mostrerà alcun dato degli utenti da parte di chatunity-bot-essential. Ciò non implica che le persone che utilizzano questa funzione possano condividere i loro dati nei numeri ufficiali._

_- I dati che chatunity-bot-essential ottiene dagli account ufficiali degli utenti, dai gruppi e dalle impostazioni degli stessi possono essere reinizializzati, modificati e/o rettificati per garantire che il Bot sia in condizioni ottimali per l'uso. (Gli utenti possono richiedere un risarcimento tramite Instagram o tramite il comando #Reporte. Devono presentare prove)._
...
_- Gli account ufficiali di chatunity-bot-essential non sono responsabili dell'uso che fai della funzione "Sub Bot"._
...
_- Quando utilizzi determinati comandi che hanno l'obiettivo di causare disagio, inquietudine, fastidio o altri termini simili, verranno applicate le rispettive sanzioni o avvisi per preservare l'integrità degli utenti e il funzionamento di chatunity-bot-essential._

*QUESTO È IL REPOSITORIO UFFICIALE*
https://github.com/chatunitycenter/chatunity-bot-essential
...
*~ Grazie per aver dedicato del tempo a informarti su chatunity-bot-essential*
`.trim();
}
